...
# Using codescene-mcp to Ensure pre-commit code health
  ...
  - If a change increases complexity or violates technical-debt goals, **automatically perform refactoring or redesign** rather than declaring it “done.” 
